...
#define OV_BIPT_fb_controlchart OV_INSTPTR_fb_functionchart
#define OV_BVPT_fb_controlchart OV_VTBLPTR_fb_functionchart

#define OV_INSTBODY_fb_controlchart \
    OV_INSTBODY_fb_functionchart \
    OV_STRING v_CMD; \
    OV_STRING_VEC v_ORDERLIST; \
    OV_STRING_VEC v_ORDEREXECUTOR;

#define OV_CIB_fb_controlchart \
    OV_CIB_fb_functionchart \
    int is_of_class_fb_controlchart:1;

#define OV_STATICINSTBODY_fb_controlchart
...
OV_TYPEDEF_INSTANCE(fb_controlchart);
...
OV_FNCEXTERN FB_FNC_TYPEMETHOD fb_controlchart_typemethod;
...
#define OV_VTBLBODY_fb_controlchart \
    OV_VTBLBODY_fb_functionchart
...
OV_TYPEDEF_VTABLE(fb_controlchart);
...
OV_DLLFNCEXPORT OV_RESULT fb_controlchart_CMD_set(
    OV_INSTPTR_fb_controlchart pobj,
    const OV_STRING value
);
...
extern OV_CLASS_DEF OV_CLASS_DEF_fb_controlchart;
OV_VAREXTERN OV_INSTPTR_ov_class pclass_fb_controlchart;
