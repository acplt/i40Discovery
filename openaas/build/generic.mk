...
OPENAASDISCOVERYSERVER_MODEL_DIR           = $(USER_DIR)openAASDiscoveryServer/model/
OPENAASDISCOVERYSERVER_INCLUDE_DIR         = $(USER_DIR)openAASDiscoveryServer/include/
...
ifeq ($(COMPILER), MSVC)
DEFINES    = /DOV_SYSTEM_$(SYSTEM)=1 /DPLT_SYSTEM_$(SYSTEM)=1 /Dov_library_open_openaas=ov_library_open_openaas_old
else
DEFINES    = -DOV_SYSTEM_$(SYSTEM)=1 -DPLT_SYSTEM_$(SYSTEM)=1 -Dov_library_open_openaas=ov_library_open_openaas_old
endif
